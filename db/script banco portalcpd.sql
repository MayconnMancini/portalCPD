...
DROP TABLE IF EXISTS 'pc_perfil';
DROP TABLE IF EXISTS 'pc_usuarios';
DROP TABLE IF EXISTS 'pc_status_balancas';
DROP TABLE IF EXISTS 'pc_balancas';
DROP TABLE IF EXISTS 'pc_prestadores_servico';
DROP TABLE IF EXISTS 'pc_status';
DROP TABLE IF EXISTS 'pc_atendimentos';
DROP TABLE IF EXISTS 'pc_ordens_servico';
DROP TABLE IF EXISTS 'pc_reparos';
...
CREATE TABLE IF NOT EXISTS `pc_atendimentos` (
  ...
  UNIQUE INDEX `numAtendimento_UNIQUE` (`numAtendimento` ASC) ,
...
CREATE TABLE IF NOT EXISTS `pc_reparos` (
  ...
  UNIQUE INDEX `numReparo_UNIQUE` (`numReparo` ASC) ,
